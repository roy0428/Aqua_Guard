...
class Statistic_page extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    List<Widget> statistic_list = [
      statisticpage(context, "Distribution of Grouped Discolouration Colour Descriptions", "assets/Statistic_example_1.png"),
      statisticpage(context, "Water Outfall Characteristics - 'Yes' Counts", "assets/Statistic_example_2.png"),
      statisticpage(context, "Water Quality Indicators - 'Yes' Counts", "assets/Statistic_example_3.png"),
