...
import 'package:AIis/drawer_page/project_video.dart';
...
class _VideoProjectsPageState extends State<VideoProjectsPage>
  ...
  Future<void> _loadFolders() async {
    ...
    appDir = Directory('${appDir.path}/VideoProjects');
    ...
    for (final folder in folders) {
      ...
      final page = ProjectVideoPage(name: projectName);
  ...
  Future<void> _addProject(String projectName) async {
    ...
    Directory newDirectory =
        Directory('${appDocDir.path}/VideoProjects/$projectName');
